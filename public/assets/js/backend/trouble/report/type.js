define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    ...
                    add_url: 'trouble/report/type/add',
                    edit_url: 'trouble/report/type/edit',
                    del_url: 'trouble/report/type/del',
                    multi_url: 'trouble/report/type/multi',
                    import_url: 'trouble/report/type/import',
                    table: 'trouble_main',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'trouble/report/type/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'trouble/report/type/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'trouble/report/type/destroy',
                                    refresh: true
                                }
                            ],
