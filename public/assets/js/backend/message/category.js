define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'message/category/index' + location.search,
                    add_url: 'message/category/add',
                    edit_url: 'message/category/edit',
                    del_url: 'message/category/del',
                    multi_url: 'message/category/multi',
                    import_url: 'message/category/import',
