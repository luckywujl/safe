define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'message/info/index' + location.search,
                    add_url: 'message/info/add',
                    edit_url: 'message/info/edit',
                    del_url: 'message/info/del',
                    multi_url: 'message/info/multi',
                    import_url: 'message/info/import',
                    table: 'message_info',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'message/info/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                        ...
                        var setting = {
                            ...
                            callback: {
                                ...
                                onClick: function(event, treeId, treeNode, clickFlag) {
                                    ...
                                    if (treeNode.id == '0') {
                                        $(".commonsearch-table input[name=message_category_id]").val('');
                                    } else {
                                        $(".commonsearch-table input[name=message_category_id]").val(category_id);
                                    }
                                    var options = table.bootstrapTable('getOptions');
                                    options.extend.add_url = 'message/info/add?category_id=' + treeNode.id
