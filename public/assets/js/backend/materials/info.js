define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'materials/info/index' + location.search,
                    add_url: 'materials/info/add',
                    edit_url: 'materials/info/edit',
                    del_url: 'materials/info/del',
                    multi_url: 'materials/info/multi',
                    import_url: 'materials/info/import',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'materials_category_id', title: __('Materials_category_id'),visible:false,operate:'in'},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'materials/info/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                        ...
                        var setting = {
                            ...
                            callback: {
                                ...
                                onClick: function(event, treeId, treeNode, clickFlag) {
                                    ...
                                    if (treeNode.id == '0') {
                                        $(".commonsearch-table input[name=materials_category_id]").val('');
                                    } else {
                                        $(".commonsearch-table input[name=materials_category_id]").val(category_id);
                                    }
                                    var options = table.bootstrapTable('getOptions');
                                    options.extend.add_url = 'materials/info/add?category_id=' + treeNode.id
