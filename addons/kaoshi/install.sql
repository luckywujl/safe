...
ALTER TABLE `__PREFIX__kaoshi_plan` ADD  `limit` tinyint(1) unsigned  NOT NULL DEFAULT 1 COMMENT '参与人员:0=全体学生,1=指定学生';

CREATE TABLE IF NOT EXISTS  `__PREFIX__kaoshi_wrong` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
