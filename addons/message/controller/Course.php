...
use addons\message\model\Main as MainModel;
use addons\message\model\Course as CourseModel;
use addons\message\model\Record as RecordModel;
use addons\message\model\Result as ResultModel;
